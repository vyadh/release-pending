...
describe("createDraftRelease", () => {
  ...
  it("should handle API errors gracefully", async () => {
    mockCreateRelease.mockRejectedValueOnce(createHttpError("Repository not found", 404))
  ...
  it("should handle authentication errors", async () => {
    mockCreateRelease.mockRejectedValueOnce(createHttpError("Bad credentials", 401))
...
describe("updateRelease", () => {
  ...
  beforeEach(() => {
    ...
    mockUpdateRelease = octokit.mockUpdateRelease
  })
  ...
  it("should handle API errors gracefully", async () => {
    ...
    mockUpdateRelease.mockRejectedValueOnce(createHttpError("Release not found", 404))
  ...
  it("should handle permission errors", async () => {
    ...
    mockUpdateRelease.mockRejectedValueOnce(createHttpError("Forbidden", 403))
